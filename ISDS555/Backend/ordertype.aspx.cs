...
public partial class Backend_ordertype : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from order_type;", cn);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (Request.QueryString["mode"] == "Edit")
        {
            ...
            SqlCommand cmd = new SqlCommand("update order_type set mode=@mode where order_type_id=@id;", cn);
        ...
        else
        {
            ...
            SqlCommand cmd = new SqlCommand("insert into order_type values(@mode);", cn);
            cmd.Parameters.Add(new SqlParameter("@mode", txtmode.Text));
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            Response.Redirect("ordertype.aspx?mode=Edit&id=" + e.CommandArgument);
        }
    }
    protected void getdetails()
    {
        ...
        SqlCommand cmd4 = new SqlCommand("select * from order_type where order_type_id=@id;", cn);
