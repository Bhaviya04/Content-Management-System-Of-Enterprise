...
<head>        
        <!-- META SECTION -->
        <title>Target Enterprises</title>            
    ...
    <body>
        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                ...
                <div class="login-logo"><center><strong style="color: #FFFFFF; font-size: xx-large">Target Enterprises</strong></center></div>
                <div class="login-body">
                    <div class="login-title"><strong>Welcome to Team 8 Tool</strong>, Please login</div>
