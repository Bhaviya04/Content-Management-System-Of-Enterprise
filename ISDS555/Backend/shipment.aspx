<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/admin.master" AutoEventWireup="true" CodeFile="shipment.aspx.cs" Inherits="Backend_shipment" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Quantity Received">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblquantity" runat="server" Text='<%#Eval("Item_Count_Received")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                </Columns>
                                                            </asp:GridView>
