<%@ Page Title="" Language="C#" MasterPageFile="~/Backend/admin.master" AutoEventWireup="true" CodeFile="dispatch.aspx.cs" Inherits="Backend_dispatch" %>
                                                            ...
                                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Available Count">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbladdress" runat="server" Text='<%#Eval("Available_Count")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Threshold Limit">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblcode" runat="server" Text='<%#Eval("Threshold_Limit")%>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
